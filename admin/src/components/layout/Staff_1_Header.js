...
function Staff1Header({ isAuthenticated, user, setIsAuthenticated, setUser }) {
      ...
      {dropdownOpen && (
        <div className="dropdown-menu-119">
          <div className="flex-row-eb-119">
            ...
            <Link to="/staff1/bookingspa">
            <span className="messenger-119"><i class="fa-solid fa-paw"></i> &nbsp;Đơn spa</span>
            </Link>
            {/* <button onClick={handleLogout} className="sign-out-119">đăng xuất &nbsp; <i class="fa-solid fa-right-from-bracket"></i></button> */}
          </div>
        </div>
