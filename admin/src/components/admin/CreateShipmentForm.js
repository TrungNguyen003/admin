...
const CreateShipmentForm = ({ isAuthenticated, user, setIsAuthenticated, setUser }) => {
  ...
  const handleChange = (e) => {
    ...
    const integerFields = [
      ...
      "cod_amount", "pick_station_id", "deliver_station_id"
    ];
  ...
  return (
    ...
    <p></p>
      ...
      <button type="submit" className="btn btn-primary">Tạo đơn hàng vận chuyển</button>
    </form>
    </div>
  );
};
